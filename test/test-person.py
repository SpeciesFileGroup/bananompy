...
def test_search_person_basic():
    ...
    res = bionompy.person.search('Mary Agnes Chase', families_collected='Poaceae', families_identified='Poaceae', strict=True)
...
def test_search_person_basic2():
    ...
    res = bionompy.person.search('smith', families_collected='scarabaeidae', strict=True)
...
def test_search_person_strict():
    ...
    strict_false = bionompy.person.search('Mary Agnes Chase', families_collected='Poaceae', families_identified='Poaceae', strict=False)
    strict_true = bionompy.person.search('Mary Agnes Chase', families_collected='Poaceae', families_identified='Poaceae', strict=True)
...
def test_search_person_families_collected():
    ...
    res = bionompy.person.search('Thomas McElrath', families_collected='Acholeplasmataceae', strict=True)
...
def test_search_person_families_identified():
    ...
    res = bionompy.person.search('Thomas McElrath', families_identified='Acholeplasmataceae', strict=True)
    assert 0 == res['opensearch:totalResults']
...
def test_search_person_page_limit():
    ...
    res = bionompy.person.search('Mary Agnes Chase', page=2, limit=1)
...
def test_search_person_date():
    ...
    res = bionompy.person.search('Smith', date=search_date, strict=True)
...
def test_search_person_callback():
    ...
    res = bionompy.person.search('Mary Agnes Chase', callback='aldkfjlasfoewhfaefoiefoaef')
...
def test_person_get():
    ...
    res = bionompy.person.get('0000-0001-7618-5230')
...
def test_person_wikidata_specimens():
    ...
    res = bionompy.person.get('Q3822242', specimens=True)
...
def test_person_orcid_specimens_csv():
      res = bionompy.person.get('0000-0001-7618-5230', specimens=True, csv=True)
